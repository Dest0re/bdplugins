(function () {
    ...
    cl.__defineGetter__("currentGuild", function () {
        if (location.pathname.split("/")[1] == "channels") {
            if (location.pathname.split("/")[2] == "@me") { return "DM"; }
            else { return BdApi.findModuleByProps("getGuild").getGuild(location.pathname.split("/")[2]); }
        }
    });
    cl.__defineGetter__("currentChannel", function () {
        if (this.currentGuild) {
            if (location.pathname.split("/")[3]) {
                return BdApi.findModuleByProps("getChannel").getChannel(location.pathname.split("/")[3]);
            }
        }
    });
